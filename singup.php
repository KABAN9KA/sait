    ...
    <?php require_once "blocks/header.php";?>
        <div class="container1">
            ...
            <form action="vhandlog/check_post_login.php" method="post">
                ...
                <label class="label-container">пароль:</label> <input class="input-container" type="password" id="password-input" name="conf_password" placeholder="подтвердите пароль"><br>
